...
import com.army.ardiary.data.remote.auth.friend.vo.Friend
...
class FriendRVAdapter(private val friendList :ArrayList<Friend>): RecyclerView.Adapter<DiaryRVAdapter.ViewHolder>() {
    var onRemoveClick:(Int) -> Unit = {}

    override fun getItemCount(): Int = friendList.size

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder
        = ViewHolder(FriendListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false), parent.context)
    ...
    inner class ViewHolder(val binding: FriendListItemBinding, val context: Context): RecyclerView.ViewHolder(binding.root){
