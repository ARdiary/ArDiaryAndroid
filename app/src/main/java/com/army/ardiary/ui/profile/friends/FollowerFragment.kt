...
class FollowerFragment : BaseFragment<FragmentFollwingBinding>(FragmentFollwingBinding::inflate) {
    ...
    private fun networkSetting(){
        ...
        friendRVAdapter = FriendRVAdapter(friendList).apply { onRemoveClick = this@FollowerFragment::friendRemove }
