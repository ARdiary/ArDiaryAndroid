...
class GuestBookRVAdapter(private val guestBookList: List<GuestBook>) :
    RecyclerView.Adapter<GuestBookRVAdapter.ViewHolder>() {
    var onLikeClick: (Int) -> Unit = {}

    override fun getItemCount(): Int = guestBookList.size

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder = ViewHolder(
        GuestBookListItemBinding.inflate(
    ...
    inner class ViewHolder(val binding: GuestBookListItemBinding, val context: Context) :
